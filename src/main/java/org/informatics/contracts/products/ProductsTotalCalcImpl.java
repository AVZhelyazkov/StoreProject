package org.informatics.contracts.products;
...
import org.informatics.contracts.products.contracts.ProductsTotalCalc;
            ...
            return getValidatedScannedProducts(checkoutId)
                    ...
                    .map(product -> {
                        ...
                        boolean isWithinExpiryDays = product.getProductExpiryDate()
                                .isAfter(LocalDate.now().minusDays(store.getProductExpiryDiscountDays()));
